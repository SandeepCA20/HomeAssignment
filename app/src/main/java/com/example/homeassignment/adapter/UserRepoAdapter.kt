...
class UserRepoAdapter(private val repoList: MutableList<UserRepos>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding =
            CustomUserRepoItemsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class MyViewHolder(private val itemsBinding: CustomUserRepoItemsBinding) :
